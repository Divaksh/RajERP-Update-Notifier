...
if(strcmp($Check1, $Check2) == 0){
	...
	if(strcmp($update_new, $update_old) == 0){
		...
		if(file_exists('/home/admin/web/divaksh.com/public_html/erpdown.log')){
			if(!file_exists('/home/admin/web/divaksh.com/public_html/erpup.log')){
			...
			file_put_contents("/home/admin/web/divaksh.com/public_html/erpup.log", $ERPup);
			}
			else{
				echo '</br>';
...
*/
	...
	if(!file_exists('/home/admin/web/divaksh.com/public_html/erpdown.log')){
		function sendMessage() {
			$content      = array(
				"en" => 'Hold tight! RajERP does not seem to be working right now. Probably update in progress.'
			);
			$heading = array(
				"en" => 'RajERP is Down!'
			);
		...
		file_put_contents("/home/admin/web/divaksh.com/public_html/erpdown.log", $ERPdown);
	}
	else{
		echo '</br>';
